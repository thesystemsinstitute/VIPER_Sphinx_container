Sphinx Argparse Example
=======================

.. note::

   **Package**: sphinx-argparse  
   **Purpose**: Document argparse CLIs  
   **Tutorial**: See :doc:`../tutorials/packages/sphinx-argparse` for complete tutorial

This page demonstrates **sphinx-argparse** - Document argparse CLIs.
