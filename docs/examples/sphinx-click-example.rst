Sphinx Click Example
====================

.. note::

   **Package**: sphinx-click  
   **Purpose**: Document Click CLIs  
   **Tutorial**: See :doc:`../tutorials/packages/sphinx-click` for complete tutorial

This page demonstrates **sphinx-click** - Document Click CLIs.
