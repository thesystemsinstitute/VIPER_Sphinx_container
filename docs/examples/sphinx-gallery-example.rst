...
.. note::
   ...
   **Purpose**: Build example galleries from scripts  
   **Tutorial**: See :doc:`../tutorials/packages/sphinx-gallery` for complete tutorial

This page demonstrates **sphinx-gallery** - Build example galleries from scripts.
...
Standard patterns for using sphinx-gallery:
...
sphinx-gallery integrates well with:
...
- :doc:`Complete Tutorial <../tutorials/packages/sphinx-gallery>`
- `PyPI Package <https://pypi.org/project/sphinx-gallery/>`_
- `Official Documentation <https://sphinx-gallery.github.io/>`_
- :ref:`Package API Documentation <pdoc-sphinx-gallery>`

Next Steps
----------

- Explore the :doc:`tutorial <../tutorials/packages/sphinx-gallery>`
