Sphinx Pydantic Example
=======================

.. note::

   **Package**: sphinx-pydantic  
   **Purpose**: Enhanced Pydantic documentation  
   **Tutorial**: See :doc:`../tutorials/packages/sphinx-pydantic` for complete tutorial

This page demonstrates **sphinx-pydantic** - Enhanced Pydantic documentation.
