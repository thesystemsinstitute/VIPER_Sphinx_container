Sphinx Sitemap Example
======================

.. note::

   **Package**: sphinx-sitemap  
   **Purpose**: Generate sitemap for docs  
   **Tutorial**: See :doc:`../tutorials/packages/sphinx-sitemap` for complete tutorial

This page demonstrates **sphinx-sitemap** - Generate sitemap for docs.
...
Standard patterns for using sphinx-sitemap:
...
sphinx-sitemap integrates well with:
...
- :doc:`Complete Tutorial <../tutorials/packages/sphinx-sitemap>`
- `PyPI Package <https://pypi.org/project/sphinx-sitemap/>`_
- `Official Documentation <https://sphinx-sitemap.readthedocs.io/>`_
- :ref:`Package API Documentation <pdoc-sphinx-sitemap>`

Next Steps
----------

- Explore the :doc:`tutorial <../tutorials/packages/sphinx-sitemap>`
