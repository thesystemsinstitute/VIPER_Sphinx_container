...
.. note::
   ...
   **Package**: sphinx-sql  
   **Purpose**: Document SQL in Sphinx  
   **Tutorial**: See :doc:`../tutorials/packages/sphinx-sql` for complete tutorial

This page demonstrates **sphinx-sql** - Document SQL in Sphinx.
