Sphinx Toolbox Example
======================

.. note::

   **Package**: sphinx-toolbox  
   **Purpose**: Collection of Sphinx extensions  
   **Tutorial**: See :doc:`../tutorials/packages/sphinx-toolbox` for complete tutorial

This page demonstrates **sphinx-toolbox** - Collection of Sphinx extensions.
