Sphinx Typer Example
====================

.. note::

   **Package**: sphinx-typer  
   **Purpose**: Document Typer CLIs  
   **Tutorial**: See :doc:`../tutorials/packages/sphinx-typer` for complete tutorial

This page demonstrates **sphinx-typer** - Document Typer CLIs.
