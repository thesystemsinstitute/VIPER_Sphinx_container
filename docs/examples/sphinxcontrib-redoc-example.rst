Sphinxcontrib Redoc Example
===========================

.. note::

   **Package**: sphinxcontrib-redoc  
   **Purpose**: Embed ReDoc API documentation  
   **Tutorial**: See :doc:`../tutorials/packages/sphinxcontrib-redoc` for complete tutorial

This page demonstrates **sphinxcontrib-redoc** - Embed ReDoc API documentation.
