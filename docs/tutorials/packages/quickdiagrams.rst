...
- `Official Documentation <https://pypi.org/project/quickdiagrams/>`_
- `PyPI Package <https://pypi.org/project/quickdiagrams/>`_
- :doc:`Example Usage <../../examples/quickdiagrams-example>`
