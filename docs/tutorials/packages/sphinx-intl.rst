...
.. note::
   ...
   **Package Resources:**
   ...
   - :doc:`See Working Example <../../examples/sphinx-intl-example>`
   - `Official Documentation <https://sphinx-intl.readthedocs.io/>`_


This tutorial demonstrates how to use sphinx-intl in your Sphinx documentation.
...
sphinx-intl is already installed in this container. To verify:

.. code-block:: bash

   docker run --rm kensai-sphinx:latest python -c "import sphinx_intl; print('Installed')"
...
Here's a basic example of using sphinx-intl:
