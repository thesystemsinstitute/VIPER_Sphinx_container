...
.. note::
   ...
   **Package Resources:**
   ...
   - `API Documentation <../../pdoc/sphinx_sql/index.html>`_
   - `Manual <https://github.com/jackscodemonkey/sphinx-sql>`_
...
.. code-block:: bash
   ...
   docker run --rm viper-sphinx:latest python -c "import sphinx_sql; print('Installed')"
...
Standard patterns for using sphinx-sql:
...
sphinx-sql integrates well with:
...
- :doc:`Complete Tutorial <../tutorials/packages/sphinx-sql>`
- :ref:`Package API Documentation <pdoc-sphinx-sql>`
Next Steps
----------
- Explore the :doc:`tutorial <../tutorials/packages/sphinx-sql>`
