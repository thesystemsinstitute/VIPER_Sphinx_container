...
---------------------
sphinx-thebe is a Sphinx extension that provides:
...
sphinx-thebe is already installed in this container. To verify:

.. code-block:: bash

   docker run --rm kensai-sphinx:latest python -c "import sphinx_thebe; print('Installed')"
...
Here's a basic example of using sphinx-thebe:
...
Standard patterns for using sphinx-thebe:
...
sphinx-thebe integrates well with:
...
- :doc:`Complete Tutorial <../tutorials/packages/sphinx-thebe>`
- :ref:`Package API Documentation <pdoc-sphinx-thebe>`
Next Steps
----------
- Explore the :doc:`tutorial <../tutorials/packages/sphinx-thebe>`
